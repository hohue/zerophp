...
$chovip_subfolder = isset($_SESSION['userid']) ? $_SESSION['userid'] : '0';

if (!$chovip_subfolder) {
    print "Bạn không được cấp quyền truy cập vào URL này";
    die;
}
...
$base_url ="http://".$_SERVER['HTTP_HOST'] . "/files";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = "/images/$chovip_subfolder/"; // path from base_url to base of upload folder (with start and final /)
$current_path = "../../files/images/$chovip_subfolder/"; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = "../../files/thumbs/$chovip_subfolder/"; // relative path from filemanager folder to thumbs folder (with final /)
...
//**********************
$ext_img = array('jpg', 'jpeg', 'png', 'gif'); //Images , 'bmp', 'tiff', 'svg'
...
*******************/
$aviary_active 	= FALSE;
$aviary_key 	= "ae93f4e5bb70d43b";
$aviary_secret	= "fe18b531374fc3bf";
$aviary_version	= 3;
$aviary_language= 'en';
